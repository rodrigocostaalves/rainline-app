...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      'Perda de material (%)': 'Material waste (%)',
      'Comprimento da descida (ft)': 'Downspout length (ft)', 'Fator de calibração': 'Calibration factor',
    ...
    es: {
      ...
      'Perda de material (%)': 'Merma de material (%)',
      'Comprimento da descida (ft)': 'Largo de la bajante (ft)', 'Fator de calibração': 'Factor de calibración',
